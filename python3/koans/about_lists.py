...
#Negative Number counts in reverse skipping index 0 and starts at -1 as value 3 index
...
#starts at the 2nd index aka ^>"and"
        self.assertEqual(['peanut', 'butter'], noms[:2])
# stopps before the 2nd index aka <^"and"
...
#when indicating a index start counting right after.
...
#this one im not sure whats going on review this 
...
# when consolded this is the result
